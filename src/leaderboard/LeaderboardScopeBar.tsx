...
const NON_GROUP_SCOPES = ['all', 'range', 'prob', 'whatif', 'summary', 'oleh', 'crossings', 'timelapse', 'records'] as const
  ...
  return (
    <div className="lb-scope-bar">
      <div className="lb-scope-modes">
        ...
        <button
          type="button"
          className={modeBtn(mode === 'timelapse')}
          aria-pressed={mode === 'timelapse'}
          onClick={() => onScopeChange('timelapse')}
        >טיימלאפס</button>
        <button
          type="button"
          className={modeBtn(mode === 'records')}
        ...
        <button
          type="button"
          className={modeBtn(mode === 'whatif')}
          aria-pressed={mode === 'whatif'}
          onClick={() => onScopeChange('whatif')}
        >מה אם</button>
      </div>
