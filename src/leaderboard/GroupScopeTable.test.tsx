...
const ROWS = [
  { label: 'Dana', tzelifaCount: 1, pgiyaCount: 5, matchPoints: 14, advancementPoints: 0, total: 14 },
  { label: 'Yossi', tzelifaCount: 3, pgiyaCount: 0, matchPoints: 12, advancementPoints: 10, total: 22 },
]
