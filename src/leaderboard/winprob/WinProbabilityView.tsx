  ...
  return (
    <div className="lb-prob">
      ...
      <p className="lb-prob-note">
        ...
        <b>לחצו על שורה</b> לסיכום אישי — ובראשו «התרחיש האופטימלי שלך»: גורל אחד קוהרנטי שמביא אתכם הכי גבוה, שבו הקבוצות שלכם מתחרות על אותם מקומות בבראקט (✕ = בחירה שנופלת בדרך, לא הפסד שרציתם),
